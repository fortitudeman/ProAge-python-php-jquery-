    ...
    <tbody class="tbody">        
		...
		$total_cobranza += ($value['cobranza']['total_due'] - $value['cobranza']['total_paid']);
            ...
            <tr id="tr_<?php echo $value['id'] ?>">
                ...
                <td class="celda_gris" style="text-align:center;"><a class="numeros fancybox_gris" href="javascript:void" title="Haga click aqui para ver los detalles" onclick="payment_popup({for_agent_id: <?php echo (int)$value['agent_id'] ?>, type: 'negocio'})"><?php echo $value['negocio'] ; ?></a>
				</td>
