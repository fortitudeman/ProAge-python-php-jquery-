...
<?php endif; ?>
                                            ...
                                            <th title="Escriba algo para ver sugerencias por el nombre del agente. Seleccione un agente. Luego, puede continuar a escribir para añadir otro nombre. Despues, click el icono 'filtrar' para actualizadar la página web.">
Nombre de los agentes :&nbsp;&nbsp;<i style="cursor: pointer" class="icon-filter" id="submit-form" title="Filtrar"></i><br />
<textarea id="agent-name" name="query[agent_name]" rows="5" class="input-xlarge select4">
