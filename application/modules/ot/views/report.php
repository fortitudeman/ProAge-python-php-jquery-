                ...
                <div class="span11" style="margin-left:40px; width:95%">
                    <div class="main-container">
                        <div class="main clearfix">                               
                            ...
                            <form id="form" class="form-inline" method="post" style="float: left">                      	
...
<?php endif; ?>
                                ...
                                <span>
                                    <textarea title="Escriba el nombre del agente que desea buscar y selecciónelo de la lista que aparece. Puede buscar más posteriormente en la siguiente línea." placeholder="AGENTES" id="agent-name" name="query[agent_name]" rows="1" class="input-xlarge select4" style="min-width: 250px; height: 2.2em"><?php echo $other_filters['agent_name']; ?></textarea>
                                ...
                                <span>
                                    <textarea title="Escriba el número de póliza que desea buscar y selecciónelo de la lista que aparece. Puede buscar más posteriormente en la siguiente línea." placeholder="PÓLIZAS" id="policy-num" name="query[policy_num]" rows="1" class="input-small select4" style="min-width: 8em; height: 2.2em"><?php echo $other_filters['policy_num']; ?></textarea>
                                    <i style="cursor: pointer; vertical-align: top" class="icon-filter submit-form" id="submit-form2" title="Filtrar"></i>
                                    <i style="cursor: pointer; vertical-align: top" class="icon-list-alt" id="clear-policy-filter" title="Ningun filtro por el número de póliza"></i>
                                </span>

                            </form>
                            </div>
                            <?php if ($export_xls == true): ?><a href="javascript:void(0);" class="download">
                            <div style="float: left"><img src="<?php echo base_url() ?>ot/assets/images/down.png"></a></div>
                            <?php endif; ?>
                            <?php
